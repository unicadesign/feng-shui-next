...
export async function proxy(request: NextRequest) {
  ...
  // Touch the user record so Supabase refreshes the auth token cookie when needed.
  // Without this call the session quietly expires and the server starts thinking the
  // user is logged out.
